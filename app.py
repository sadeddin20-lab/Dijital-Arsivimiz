...
if os.path.exists(BACKGROUND_IMAGE):
    ...
    st.markdown(f"""
        ...
        .stApp {{
            ...
            /* 🚨 KESİLMEYİ VE BEYAZ ÇİZGİYİ ÖRTEN NİZAM 🚨 */
            background-size: cover !important; 
            background-position: center top !important; 
            background-repeat: no-repeat !important;
            background-attachment: fixed !important;
            /* Resmin en üstüne küçük bir negatif pay vererek beyaz satırı gömdük */
            margin-top: -5px !important;
            background-color: #121212 !important;
            color: #FFFFFF;
        }}
        
        h1 {{ font-size: 20px !important; margin-top: 15px !important; text-shadow: 2px 2px 5px #000; }}
        h3, p {{ font-size: 12px !important; margin-bottom: 2px !important; text-shadow: 2px 2px 5px #000; }}
        ...
        .stFileUploader button {{
            ...
            padding: 8px 15px !important; width: 100% !important; max-width: 350px !important; 
